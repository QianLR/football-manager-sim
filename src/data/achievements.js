export const ACHIEVEMENTS = [
  ...
  {
    id: 'bayern_turmoil_ucl',
    title: '你不明白这件事的底层逻辑，但…',
    hint: '执教拜仁慕尼黑，并在更衣室动荡时期拿到欧冠冠军。',
    clue: '证明拜仁慕尼黑在欧冠赛场的某种定律。'
  },
  {
    id: 'bayern_5_years',
    title: '感性老农，在线锄草',
    hint: '您已执教拜仁慕尼黑超过五个赛季。如果有多余的资金，能修一下我们的菜地吗？',
    clue: '在安联菜地务农五个赛季。'
  },
  {
    id: 'musiala_bayern_fired',
    title: '老鹿斑比',
    hint: '你来得也太早了吧？',
